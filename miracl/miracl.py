...
# Generation date: 2022-03-14T18:29:11
# Schema: miracl
#
# id: https://w3.org/miracl
# description: This is a preliminary convertion of the Minimal Information Reporting About a Cell into a
#              computer-readable, LinkML schema. The schema is fairly minimal and is in the form of a "checklist"
#              style schema. It is a set of fields mostly associated with this class: * [CellType](CellType.md)
#              There are a set of examples here: *
#              [tests/input](https://github.com/lubianat/miracl-schema/tree/main/tests/input) Currently the
#              examples are YAML, but the YAML is deliberately flat as this is a "checklist" schema, and we could
#              have TSV/CSV/xlsx here Future extensions: - include "packages" and "checklists"; e.g. - a neuron
...
class CellType(YAMLRoot):
    """
    Minimal Information Reporting About a Cell
    """
